...
resource_access_response = http_get_call(("%s/transactions/123" % kong_proxy_url), {'content-type': 'application/json', 'authorization': ('bearer %s' % token_response['access_token']), 'Host': kong_route_host})
