...
Source0:	gluu-gateway-4.2.2.tar.gz
Source1:	gluu-gateway.service
Source3:	konga.service
BuildArch:      noarch
Requires:	postgresql10, postgresql10-server, nodejs, lua-cjson, unzip, python36-requests, ca-certificates, logrotate, zlib-devel
